...
class AppCommand(Enum):
    ...
    LOCK = "lock"        # lock the slide (which favorites it and asks for the better version)
...
_say(AppCommand.LEARNED, "human inspired")
_say(AppCommand.LEARNED_ON, "human inspired on")
