...
wears a translucent chip in its top-right corner — a play triangle for a video, a
...
Top-right is the one corner of a tile that is not a control: the star, the trash
can and the plus own the other three (see
:mod:`origenerator.gui.corner_controls`), and this is the one mark that only
reports and never acts, so it is the one that keeps out of their way.
...
class MediaBadge(QLabel):
    """A play/photo chip overlaid on the top-right corner of a Recents tile."""
