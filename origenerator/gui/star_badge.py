...
The user bookmarks individual generations; a starred tile wears a gold star in
its top-right corner — opposite the media-type badge and re-roll controls that
sit top-left — so a bookmark reads at a glance. The badge parents to its tile and
positions itself; the tile shows or hides it as the star is toggled.
...
class StarBadge(QLabel):
    """A gold-star chip overlaid on the top-right corner of a starred tile."""
