...
class Wan22I2vWorkflow(WorkflowTemplate):
    ...
    def param_definitions(self) -> list[ParamDef]:
        ...
        return [
            ...
            ParamDef("scene_lines", "Her Lines", "lines", defaults["scene_lines"]),
            ...
            ParamDef("voice_sample_text", "Words in the Voice Sample", "str", defaults["voice_sample_text"], multiline=True),
            ...
            ParamDef("split_step", "Handoff Step", "int", defaults["split_step"], min_val=0, max_val=100),
            ParamDef("cfg_high", "Prompt Strength (First Pass)", "float", defaults["cfg_high"], min_val=0.0, max_val=30.0, step=0.1),
            ParamDef("cfg_low", "Prompt Strength (Second Pass)", "float", defaults["cfg_low"], min_val=0.0, max_val=30.0, step=0.1),
            ...
            *wan_expert_model_params(defaults),
            ParamDef("unet_s2v", "Speaking Model", "combo", defaults["unet_s2v"], options=speech),
