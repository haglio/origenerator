...
class SdxlPoseTransferWorkflow(WorkflowTemplate):
    ...
    def param_definitions(self) -> list[ParamDef]:
        ...
        return [
            ...
            ParamDef("input_image", "Structure Image", "image", defaults["input_image"],
                     browse_dir=CUSTOM_POSES_DIR),
            ParamDef("checkpoint", "Model", "combo", defaults["checkpoint"],
                     options=checkpoints),
            ParamDef("control_mode", "Structure From", "combo", defaults["control_mode"],
                     options=["depth", "pose"]),
            ParamDef("controlnet", "Structure Model", "combo", defaults["controlnet"],
                     options=controlnets),
            ParamDef("controlnet_strength", "Structure Strength", "float", defaults["controlnet_strength"],
                     min_val=0.0, max_val=2.0, step=0.05),
            ParamDef("controlnet_end", "Structure Hold", "float", defaults["controlnet_end"],
            ...
            ParamDef("sampler_name", "Drawing Method", "combo", defaults["sampler_name"],
                     options=SAMPLER_OPTIONS),
            ParamDef("scheduler", "Step Spacing", "combo", defaults["scheduler"],
