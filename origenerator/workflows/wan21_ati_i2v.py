...
class Wan21AtiI2vWorkflow(WorkflowTemplate):
    ...
    def param_definitions(self) -> list[ParamDef]:
        ...
        return [
            ...
            ParamDef("audio_prompt", "Sound Prompt", "str", defaults["audio_prompt"], multiline=True),
            ParamDef("audio_negative_prompt", "Sounds to Avoid", "str", defaults["audio_negative_prompt"], multiline=True),
            ParamDef("seed", "Seed", "seed", defaults["seed"]),
            ParamDef("audio_seed", "Sound Seed", "seed", defaults["audio_seed"]),
            ParamDef("motion_hz", "Cycles per Second", "float", defaults["motion_hz"], min_val=0.2, max_val=4.0, step=0.1),
            ...
            ParamDef("motion_x", "Motion Across", "int", defaults["motion_x"], min_val=0, max_val=REFERENCE_WIDTH),
            ParamDef("motion_ceiling", "Motion High Point", "int", defaults["motion_ceiling"], min_val=0, max_val=REFERENCE_HEIGHT),
            ParamDef("motion_floor", "Motion Low Point", "int", defaults["motion_floor"], min_val=0, max_val=REFERENCE_HEIGHT),
            ParamDef("anchor_x", "Still Point Across", "int", defaults["anchor_x"], min_val=0, max_val=REFERENCE_WIDTH),
            ParamDef("anchor_y", "Still Point Down", "int", defaults["anchor_y"], min_val=0, max_val=REFERENCE_HEIGHT),
            ...
            ParamDef("shift", "Composition Focus", "float", defaults["shift"], min_val=0.0, max_val=20.0, step=0.5),
            ParamDef("unet", "Model", "combo", defaults["unet"], options=models),
            ParamDef("lora_high", "Add-on (First Pass)", "combo", defaults["lora_high"], options=loras_high),
            ParamDef("lora_strength_high", "Add-on Strength (First Pass)", "float", defaults["lora_strength_high"], min_val=0.0, max_val=2.0, step=0.05),
            ParamDef("lora_low", "Add-on (Second Pass)", "combo", defaults["lora_low"], options=loras_low),
            ParamDef("lora_strength_low", "Add-on Strength (Second Pass)", "float", defaults["lora_strength_low"], min_val=0.0, max_val=2.0, step=0.05),
