...
class Wan21AtiI2vWorkflow(WorkflowTemplate):
    ...
    def param_definitions(self) -> list[ParamDef]:
        ...
        return [
            ...
            ParamDef("motion_x", "Motion Across", ParamType.INT, defaults["motion_x"], min_val=0, max_val=REFERENCE_WIDTH),
            ParamDef("motion_ceiling", "Motion High Point", ParamType.INT, defaults["motion_ceiling"], min_val=0, max_val=REFERENCE_HEIGHT),
            ParamDef("motion_floor", "Motion Low Point", ParamType.INT, defaults["motion_floor"], min_val=0, max_val=REFERENCE_HEIGHT),
            ParamDef("anchor_x", "Still Point Across", ParamType.INT, defaults["anchor_x"], min_val=0, max_val=REFERENCE_WIDTH),
            ParamDef("anchor_y", "Still Point Down", ParamType.INT, defaults["anchor_y"], min_val=0, max_val=REFERENCE_HEIGHT),
            ParamDef("frame_count", "Duration", ParamType.INT, defaults["frame_count"], min_val=5, max_val=113, step=4,
            ...
            ParamDef("shift", "Composition Focus", ParamType.FLOAT, defaults["shift"], min_val=0.0, max_val=20.0, step=0.5),
            ParamDef("unet", "Model", ParamType.COMBO, defaults["unet"], options=models),
            ParamDef("lora_high", "Add-on (First Pass)", ParamType.COMBO, defaults["lora_high"], options=loras_high),
